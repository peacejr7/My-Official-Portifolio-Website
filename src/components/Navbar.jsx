        ...
        >
            <div className="flex items-center justify-between w-full space-x-6 lg:space-x-8">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    whileHover={{scale:1.05}}
                    whileTap={{scale:0.95}}
                    className={`hidden lg:block px-6 py-2 fpnt-semibold rounded-full bg-linear-to-r ${colors.button}
            ...
            {isMenuOpen && (
                ...
                className={`absolute top-full left-0 right-0 mt-2 lg:hidden
                 ${darkMode
                    ?'bg-gray-900/95'
                    :'bg-white/95' } backdrop-blur-lg rounded-xl shadow-lg border ${
                        ...
                        <div className="px-4 py-3 space-y-2">
                            ...
                            whileTap={{scale:0.95}}
                            className={`block py-3 px-4 text-center font-semibold rounded-lg bg-liear-to-r
